...
const socialLinks = [
  { name: 'Instagram', href: 'https://www.instagram.com/tacostechnology/', icon: 'IG' },
];
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-sm font-bold text-gray-400 hover:text-white hover:bg-[#2d5a8a] hover:border-[#2d5a8a] transition-all duration-300"
